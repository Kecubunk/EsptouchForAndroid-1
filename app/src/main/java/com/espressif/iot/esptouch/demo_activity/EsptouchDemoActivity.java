...
public class EsptouchDemoActivity extends Activity implements OnClickListener {
	...
	private Handler mainHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what){
				case 1:
					mLogMessage.setText(msg.obj.toString());
					break;
				default:
					break;
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLogMessage = (TextView) findViewById(R.id.log_message);
		initSpinner();
	}
	
	private void initSpinner()
	{
		log = new MLog(mainHandler);
	...
	public void onClick(View v) {
		...
		if (v == mBtnConfirm) {
			...
			new EsptouchAsyncTask3(mainHandler).execute(apSsid, apBssid, apPassword,
		...
		protected IEsptouchResult doInBackground(String... params) {
			synchronized (mLock) {
				...
				mEsptouchTask = new EsptouchTask(apSsid, apBssid, apPassword,
						isSsidHidden, EsptouchDemoActivity.this, Task2Handler);
			}
	...
	private class EsptouchAsyncTask3 extends AsyncTask<String, Void, List<IEsptouchResult>> {
		...
		// 3. Oops, the task should be cancelled, but it is running
		private final Object mLock = new Object();
		private Handler task3Handler;

		public EsptouchAsyncTask3(Handler handler){
			task3Handler = handler;
		}
		@Override
		protected void onPreExecute() {
			mProgressDialog = new ProgressDialog(EsptouchDemoActivity.this);
		...
		protected List<IEsptouchResult> doInBackground(String... params) {
			...
			synchronized (mLock) {
				...
				mEsptouchTask = new EsptouchTask(apSsid, apBssid, apPassword,
						isSsidHidden, EsptouchDemoActivity.this, task3Handler);
